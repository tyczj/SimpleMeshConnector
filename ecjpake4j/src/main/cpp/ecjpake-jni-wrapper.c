...
// The values here are taken from the com.tycz.ecjpake4j.Role enum.
...
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_createNativeComponents(JNIEnv *env, jobject instance,
                                                              jstring seedData
) {
...
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_setupJpake(JNIEnv *env, jobject instance,
...
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_writeRoundOne(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_readRoundOne(JNIEnv *env, jobject instance,
                                                    jobject componentsPointer,
...
JNIEXPORT jbyteArray JNICALL
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_writeRoundTwo(JNIEnv *env, jobject instance,
                                                     jobject componentsPointer) {
    CryptoComponents* cc = get_components(env, componentsPointer);
...
JNIEXPORT jint JNICALL
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_readRoundTwo(JNIEnv *env, jobject instance,
                                                    jobject componentsPointer,
...
JNIEXPORT jbyteArray JNICALL
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_deriveSecret(JNIEnv *env, jobject instance,
                                                    jobject componentsPointer) {
    CryptoComponents* cc = get_components(env, componentsPointer);
...
Java_jtycz_simple_mesh_connector_security_ECJPakeImpl_freePointers(JNIEnv *env, jobject instance,
                                                    jobject componentsPointer) {
    CryptoComponents* cc = get_components(env, componentsPointer);
