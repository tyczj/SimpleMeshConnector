package jtycz.simple.mesh.connector.security

import io.particle.mesh.setup.connection.security.JpakeExchangeManager
import io.particle.mesh.setup.connection.security.JpakeExchangeMessageTransceiver
...
class Security {
    ...
    suspend fun createCryptoDelegate(jpakeLowEntropyPassword: String,frameWriter: OutboundFrameWriter,frameReader: InboundFrameReader): AesCcmDelegate? {
